package de.hindenbug.tomcat.valves;
 ...
 * <code>remoteHost, user, timeStamp, requesturi, query, status, bytes</code>
 * </p>
 * <p>
...
public class JDBCAccessLogValve extends ValveBase implements AccessLog {
    ...
    /**
     * Sets the name of the field containing the query part of the HTTP query.
     *
     * @param requestURIField The name of the field containing the URL part of
     *                   the HTTP query.
     */
    public void setRequestURIField(String requestURIField) {
        this.requestURIField = requestURIField;
    }
            ...
            while (numberOfTries > 0) {
                try {
                    ...
                    if (useLongContentLength) {
                        ...
                        ps.setInt(7, (int) bytes);
                    }
                    if (logPattern.equals("combined")) {
                        ps.setString(8, virtualHost);
                        ps.setString(9, method);
                        ps.setString(10, referer);
